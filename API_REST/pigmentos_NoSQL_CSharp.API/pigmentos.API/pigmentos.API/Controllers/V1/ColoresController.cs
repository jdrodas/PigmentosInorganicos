...
namespace pigmentos.API.Controllers.V1
{
    ...
    public class ColoresController(ColorService colorService) : Controller
    {
        ...
        [HttpGet("{colorId:length(24)}")]
        public async Task<IActionResult> GetByIdAsync(string colorId)
        {
            try
            {
        ...
        [HttpGet("{colorId:length(24)}/pigmentos")]
        public async Task<IActionResult> GetAssociatedPigmentsAsync(string colorId)
        {
            try
            {
