...
namespace pigmentos.API.Services
{
                                 ...
                                 IFamiliaRepository familiaRepository)
    {
        ...
        public async Task<Pigmento> CreateAsync(Pigmento unPigmento)
        {
            ...
            if (colorExistente.Id == string.Empty)
                throw new AppValidationException($"No hay color registrado con el id {unPigmento.ColorId}.");

            unPigmento.ColorNombre = colorExistente.Nombre;
            unPigmento.ColorRepresentacionHexadecimal = colorExistente.RepresentacionHexadecimal;
            ...
            unPigmento.FamiliaQuimicaNombre = familiaExistente.Nombre;
            unPigmento.FamiliaQuimicaComposicion = familiaExistente.Composicion;
        ...
        public async Task<Pigmento> UpdateAsync(Pigmento unPigmento)
        {
            ...
            if (pigmentoExistente.Id == string.Empty)
